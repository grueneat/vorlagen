...
- id: brand:inside_page
  reason: 'IDML-imported flyer template (scaffold). The IDML spread coordinate system
    ...
    declared page''s trim box (worst overshoots 1.5-108.0mm). tools/idml_to_dsl.py
...
format: A4
id: flyer-a6-hochformat-gruenes-cover
description: A6-Flyer im Hochformat mit durchgehend grünem Marken-Cover. Für textbetonte
  Botschaften.
variant_label: Hochformat · Grünes Cover
...
previews_for_sla: 953ddba4d847bccb563957a8efd9eb0f581ab8b2fbe2db8320f785acf3ed8a1f
title: Flyer A6 Hochformat – Grünes Cover
version: 0.1.0
build_py_sha256: 68b498ce92129d18737068506c4d1ea1d0efd0777bf472309d6bfda376653ea8
_downloads:
- label: Burgenland
  bundesland: bgld
...
- label: Seite 2
  src: /templates/flyer-a6-hochformat-gruenes-cover/page-02.png
- label: Seite 3
  src: /templates/flyer-a6-hochformat-gruenes-cover/page-03.png
- label: Seite 4
  src: /templates/flyer-a6-hochformat-gruenes-cover/page-04.png
- label: Seite 5
  src: /templates/flyer-a6-hochformat-gruenes-cover/page-05.png
- label: Seite 6
