...
- id: brand:font_family
  reason: 'IDML-imported flyer template (scaffold). Text frame ''ub3b'' (the page-5
    Zitat block) renders ''Vollkorn Bold Italic'': the InDesign source story (Story_ub3e.xml)
    authored that CharacterStyleRange with AppliedFont=Vollkorn FontStyle=''Bold Italic'',
    and tools/idml_to_dsl.py emits the source font verbatim. The Grüne CI (shared/ci.yml::fonts)
    sanctions only the ''Vollkorn Black Italic'' weight. This is a genuine non-conformance
    in the source IDML asset, NOT a converter bug — changing the weight in build.py
    would diverge from the InDesign-authored baseline.pdf convergence target. Same
    converter-verbatim-emit gap class as the brand:font_family override on the sibling
    leporello templates. Resolution path: brand-team decision — either re-author the
    IDML Zitat style to Vollkorn Black Italic upstream, or add Vollkorn Bold Italic
    to the sanctioned CI font list.'
...
format: A4
id: flyer-a6-querformat-zweigeteilt
description: A6-Flyer im Querformat mit zweigeteiltem Cover – Bildfläche und Farbfläche
  kombiniert.
variant_label: Querformat · Zweigeteilt
...
previews_for_sla: efd0641d9b6132b458a4742000ead0085a98ddd2b798975d5639b838050269d3
title: Flyer A6 Querformat – Zweigeteilt
version: 0.1.0
build_py_sha256: a942d2966d89c8c750f5f8b1bc5185ffcc2242e7d4171ab662e50954efe7dd36
_downloads:
- label: Burgenland
  bundesland: bgld
...
- label: Seite 2
  src: /templates/flyer-a6-querformat-zweigeteilt/page-02.png
- label: Seite 3
  src: /templates/flyer-a6-querformat-zweigeteilt/page-03.png
- label: Seite 4
  src: /templates/flyer-a6-querformat-zweigeteilt/page-04.png
- label: Seite 5
  src: /templates/flyer-a6-querformat-zweigeteilt/page-05.png
- label: Seite 6
