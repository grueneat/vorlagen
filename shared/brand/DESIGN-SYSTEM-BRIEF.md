...
| 2026-05-09 | V1 · `kandidat-falzflyer-din-lang` "Falz-Rhythm" + M-Basis fix (Source: `improvements/05-kandidat-falzflyer.md`) | **5/5 V1 templates COMPLETE.** Universal Top-Band-System über alle 6 Panele, P3↔P6 grüne-Klammer (vollflächig), P1 Name-Card + P2 Body-Backing, P4/P5 themen sub-layout mirror mit Hellgrün-Trenner, P6 2-Spalten Kontakt symmetric um AXIS_P6_CENTER_X=247.5. ParaStyle-Migration: 12→16 falzflyer/* (10 mutations + 4 NEW: slogan-on-green, quote-on-green, top-title, themen-eyebrow). 22 CONSTRAINTS, 21 NEW geometry tests inkl. parametric M-Basis-Regression über alle 5 V1 templates. **M-Basis-Konflikt resolved (no tool change):** brand:logo_size_3M-Regel war bereits trim-konsistent; misleading build.py header comment fixed + 3 Logos resized 20/16/17 → 38mm Print-Soll (P2-Klein-Logo gelöscht; Top-Band ersetzt). brand_overrides: 4 entries → 3 (image_text_overlap RESTORED empirisch — V1 P6 vollflächig footer rhythm intentionally overlaps Impressum below P6 Logo). | https://github.com/GrueneAT/vorlagen/issues/37 (V1 only; V2/V3 backlog) |
