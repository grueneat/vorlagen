...
def _add_page_0(doc: Document, page0) -> None:  # overrides task-3 stub
    ...
    page0.add(ImageFrame(
        ...
        anname='u13e4',
        layer=0,
        # frame_visibility playbook (L-014 class): inline_image_data PNG renders
        # fully transparent under Scribus 1.6.x SCALETYPE=1; switched to image= ref
        # + scale_type=0 (fit-to-frame) per idml-tune worked example u141.
        image='../../shared/assets/26-03-flyer-a6-hochformat-gruenes-cover/gruene-logo-bund-weiss-cmyk.png',
        scale_type=0,
    ))
...
def _add_page_4(doc: Document, page4) -> None:  # overrides task-3 stub
    ...
    page4.add(ImageFrame(
        ...
        anname='u1260',
        layer=0,
        # frame_visibility playbook: SCALETYPE=1 + local_scale rendered the photo
        # invisible (preview ink density 0.0); switched to scale_type=0 fit-to-frame
        # per idml-tune worked example u2cd.
...
def _add_page_5(doc: Document, page5) -> None:  # overrides task-3 stub
    ...
    # noinject: real IDML-placed Leonore portrait photo; genuine template content, not a demo placeholder
    page5.add(ImageFrame(
        ...
        anname='u145b',
        layer=0,
        # frame_visibility playbook: switched to scale_type=0 fit-to-frame for
        # consistent crop with the baseline portrait placement.
    ...
    # P5/playbook y_mm_shift.py: y_mm 132.8956 → 133.3956 (calibration probe (+0.5mm))
    page5.add(TextFrame(
        x_mm=48.3371,
        y_mm=133.3956,
        w_mm=41.6629,
