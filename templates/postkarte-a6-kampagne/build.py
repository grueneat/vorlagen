...
doc = Document(
    ...
    extra_pdf_attrs={'CMethod': '0', 'Clip': '0', 'Encrypt': '0', 'FontEmbedding': '0', 'ImageP': 'sRGB display profile (ICC v2.2)', 'ImagePr': '0', 'InfoString': '', 'Intent': '1', 'Intent2': '0', 'PageLayout': '0', 'PassOwner': '', 'PassUser': '', 'Permissions': '-4', 'PresentMode': '0', 'PrintP': 'PSO Uncoated ISO12647 (ECI)', 'RGBMode': '1', 'RecalcPic': '0', 'RotateDeg': '0', 'SolidP': 'sRGB display profile (ICC v2.2)', 'Thumbnails': '0', 'UseLayers': '0', 'UseLpi': '0', 'UseProfiles': '0', 'UseProfiles2': '0', 'UseSpotColors': '1', 'Version': '14', 'colorMarks': '0', 'displayBookmarks': '0', 'displayFullscreen': '0', 'displayLayers': '0', 'displayThumbs': '0', 'doMultiFile': '0', 'docInfoMarks': '0', 'firstUse': '0', 'fitWindow': '0', 'hideMenuBar': '0', 'hideToolBar': '0', 'openAfterExport': '0', 'rangeSel': '0', 'rangeTxt': '', 'registrationMarks': '0'},
    layers=[
...
page1.add(TextFrame(
    ...
    runs=[
        ...
        Run(text='', separator='para', paragraph_style='Headline sehr wichtig'),
        ...
        Run(text='Millionen erben, zahlen nichts.', separator='para', paragraph_style='Fließtext'),
        Run(text='', separator='para', paragraph_style='Unterüberschrift'),
