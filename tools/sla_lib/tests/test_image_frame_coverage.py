...
class ImageFrameCoverageTests(unittest.TestCase):
    ...
    def test_kandidat_falzflyer_din_lang(self):
        self._check("kandidat-falzflyer-din-lang")
    ...
    def test_themen_plakat_a3_quer(self):
        self._check("themen-plakat-a3-quer")

    def test_wahlaufruf_postkarte_a6_quer(self):
        self._check("wahlaufruf-postkarte-a6-quer")

    def test_wahltag_tueranhaenger(self):
        self._check("wahltag-tueranhaenger")
